...
MainHall.keys = function()
{
   return Object.keys(MainHall.properties);
};

MainHall.values = function()
{
   return Object.values(MainHall.properties);
};

MainHall.keys().forEach(function(buildingKey)
{
