...
SilkManufactory.keys = function()
{
   return Object.keys(SilkManufactory.properties);
};

SilkManufactory.values = function()
{
   return Object.values(SilkManufactory.properties);
};
...
SilkManufactory.keys().forEach(function(buildingKey)
{
...
if (Object.freeze)
{
   Object.freeze(SilkManufactory);
}

export default SilkManufactory;