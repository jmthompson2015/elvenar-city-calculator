...
const MainHallDataFetcher = {};

MainHallDataFetcher.fetch = function(typeName, propertiesFunction, spanId1In)
{
...
const typeName = "Main Hall";

const propertiesFunction = function(properties)
{
   return properties.replace(/\"BuildingType.MAIN_HALL\"/g, "BuildingType.MAIN_HALL");
};

MainHallDataFetcher.fetch(typeName, propertiesFunction);